...
//  Step Tracker
//
//  Created by Alexey Kremnev on 2/1/25.
//
                ...
                if let selectedHealthMetric {
                    RuleMark(x: .value("Selected Metric", selectedHealthMetric.date, unit: .day))
                        ...
                        .annotation(
                            position: .top,
                            spacing: 0,
                            overflowResolution: .init(x:
                                    .fit(to: .chart), y: .disabled)) {
                                        annotationView
                                    }
                }
...
#Preview {
    StepBarChart(selectedStat: .steps, chartData: HealthMetric.mackData)
}
